...
\begin{mdframed}
{\bf Knowledge Box:} The '\#' symbol denotes a preprocessor flag...
\end{mdframed}
\begin{lstlisting}
#if USEBOOL == 0
    #if MALLOC == 1      
