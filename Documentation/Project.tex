...
\subsection{Valgrind and GProf output}
...
\lstinputlisting[language={[x86masm]Assembler},caption={Fully Optimised C Assembly code}]{../Sequential/boolInt.s}
\end{document}