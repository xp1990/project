...
#pragma omp parallel shared(grid_ptr, new_grid_ptr, temp_ptr, nthreads) private(gen, tid, start, stop)  num_threads(nthreads)
{
    ...
    //....
\end{lstlisting}
\subsubsection{Optimising features}
inline/register, O3.
\subsubsection{Shared or Private Memory}
